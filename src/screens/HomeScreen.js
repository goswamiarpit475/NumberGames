...
export const HomeScreen=({navigation})=> {
    ...
    const ItemMenu=({item})=>{
      return(
        ...
        {{opacity:0.8}} resizeMode="contain" source={require('../assets/images/cloud/cloud-red.png')}>
    ...
    <ImageBackground style={{flex:1}} resizeMode="cover" source={require('../assets/images/gif/under-water.gif')}>
    <Button onPress={()=>BackHandler.exitApp()} style={{alignSelf:"flex-start"}}
      ...
      <View style={{flex:1,justifyContent:'center',alignItems:'center'}}>
        <FlatList horizontal 
          ...
          {title: 'Practice', key: 'item2',navigationPath:'NumberQuiz'},
  ...
  const styles = StyleSheet.create({
    menuText: {
      fontSize: 35, color: 'yellow',fontFamily:'Rancho_400Regular',
      flexWrap: 'wrap'
    },
  });